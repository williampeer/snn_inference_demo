...
class GLIF_soft_positive_weights(nn.Module):
    ...
    def __init__(self, parameters, N=12, w_mean=0.2, w_var=0.15, neuron_types=torch.tensor([1, 1])):
        super(GLIF_soft_positive_weights, self).__init__()
        ...
        self.neuron_types = torch.transpose((torch.ones((self.N, self.N))), 0, 1)
